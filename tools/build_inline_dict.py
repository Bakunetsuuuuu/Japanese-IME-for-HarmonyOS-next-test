...
VERBS = [
    ...
    ('うご',     '動か',     conj_godan_su),  # 動かす → r_stem=うごか, k_stem=動か
    ...
    ('かち',     '勝',       conj_godan_tsu),  # 勝つ r_stem=か, but also かつ...
    ('ほ',       '保',       conj_godan_tsu),  # 保つ (たも-つ) → r_stem=たも
    ('たも',     '保',       conj_godan_tsu),
    # godan-nu
    ('し',       '死',       conj_godan_nu),
    # godan-bu
    ...
    ('は',       '運',       conj_godan_bu),  # 運ぶ → r_stem=はこ
    ('はこ',     '運',       conj_godan_bu),
    ('なら',     '並',       conj_godan_bu),  # 並ぶ
    ('えら',     '選',       conj_godan_bu),  # 選ぶ
    ('あそ',     '遊',       conj_godan_bu),
    ('こ',       '結',       conj_godan_bu),  # 結ぶ → r_stem=むす
    ('むす',     '結',       conj_godan_bu),
    ('よろこ',   '喜',       conj_godan_bu),
