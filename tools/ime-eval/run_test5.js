#!/usr/bin/env node
// Fifth held-out TEST corpus (corpus_test5.js/accept_test5.js). Per the
...
function main() {
  ...
  const corpus = require('./corpus_test5.js');
  const accept = require('./accept_test5.js');
  ...
  console.log(`[TEST5] strict accuracy : ${strict}/${n} (${(100 * strict / n).toFixed(1)}%)`);
  console.log(`[TEST5] lenient accuracy: ${lenient}/${n} (${(100 * lenient / n).toFixed(1)}%)`);
  if (showMisses) {
