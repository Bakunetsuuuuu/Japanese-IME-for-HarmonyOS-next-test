#!/usr/bin/env node
// Seventh held-out TEST corpus (corpus_test7.js/accept_test7.js). Per the
...
function main() {
  ...
  const accept = require('./accept_test7.js');
  ...
  console.log(`[TEST7] strict accuracy : ${strict}/${n} (${(100 * strict / n).toFixed(1)}%)`);
  console.log(`[TEST7] lenient accuracy: ${lenient}/${n} (${(100 * lenient / n).toFixed(1)}%)`);
  if (showMisses) {
