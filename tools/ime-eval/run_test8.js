#!/usr/bin/env node
// Eighth held-out TEST corpus (corpus_test8.js/accept_test8.js). Per the
...
function main() {
  ...
  const corpus = require('./corpus_test8.js');
  const accept = require('./accept_test8.js');
  ...
  console.log(`[TEST8] strict accuracy : ${strict}/${n} (${(100 * strict / n).toFixed(1)}%)`);
  console.log(`[TEST8] lenient accuracy: ${lenient}/${n} (${(100 * lenient / n).toFixed(1)}%)`);
  if (showMisses) {
