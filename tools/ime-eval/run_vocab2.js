...
// sentence conversion. See vocab_test2.js for why this exists: corpus_test.js
...
function main() {
  ...
  const words = require('./vocab_test2.js');
  let hit = 0;
  const misses = [];
  ...
  console.log(`[VOCAB2] coverage: ${hit}/${n} (${(100 * hit / n).toFixed(1)}%)`);
  if (showMisses) {
