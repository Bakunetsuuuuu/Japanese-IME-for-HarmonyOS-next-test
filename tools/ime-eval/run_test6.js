#!/usr/bin/env node
// Sixth held-out TEST corpus (corpus_test6.js/accept_test6.js). Per the
...
function main() {
  ...
  const corpus = require('./corpus_test6.js');
  const accept = require('./accept_test6.js');
  ...
  console.log(`[TEST6] strict accuracy : ${strict}/${n} (${(100 * strict / n).toFixed(1)}%)`);
  console.log(`[TEST6] lenient accuracy: ${lenient}/${n} (${(100 * lenient / n).toFixed(1)}%)`);
  if (showMisses) {
